  ...
  function updateDecorations() {
    ...
    const confettiDecorationType = vscode.window.createTextEditorDecorationType({
      after: {
        ...
        contentIconPath: getSvgDataUri(Date.now().toString()), //vscode.Uri.parse(`data:image/svg+xml,%3Csvg version='1.1' id='${activeEditor.selection.active.character}' xmlns='http://www.w3.org/2000/svg' viewBox='100 70 150 150' style='position: absolute;' overflow='visible'%3E%3Cstyle%3E @keyframes confdash %7B 0%25, 2%25 %7B stroke-dasharray: 1000; stroke-dashoffset: 500; transform: translate(-30px, 30px); opacity: 0; %7D 35%25 %7B stroke-dasharray: 1000; stroke-dashoffset: 900; transform: translate(-2px, 0); opacity: 1; %7D 85%25 %7B stroke-dasharray: 1000; stroke-dashoffset: 1000; transform: translate(1px, -5px); opacity: 1; %7D 90%25 %7B stroke-dashoffset: 1000; transform: translate(2px, -8px); opacity: 0; %7D to %7B stroke-dashoffset: 500; transform: translate(2px, -8px); opacity: 0; %7D %7D @keyframes confa %7B 0%25 %7B opacity: 0; transform: translate(-30px, 20px) rotate(0); %7D 15%25 %7B opacity: 1; transform: translate(25px, -10px) rotate(60deg); %7D 80%25 %7B opacity: 1; transform: translate(33px, -18px) rotate(180deg); %7D to %7B opacity: 0; transform: translate(37px, -23px) scale(0.5) rotate(230deg); %7D %7D @keyframes confb %7B 0%25 %7B opacity: 0; transform: translate(-30px, 20px) rotate(0); %7D 12%25 %7B opacity: 1; transform: translate(25px, -10px) rotate(60deg); %7D 76%25 %7B opacity: 1; transform: translate(33px, -18px) rotate(180deg); %7D to %7B opacity: 0; transform: translate(37px, -23px) scale(0.5) rotate(240deg); %7D %7D @keyframes confc %7B 0%25 %7B opacity: 0.7; transform: translate(-30px, 20px) rotate(0); %7D 18%25 %7B opacity: 1; transform: translate(5px, -10px) rotate(60deg); %7D 76%25 %7B opacity: 1; transform: translate(13px, -18px) rotate(180deg); %7D to %7B opacity: 0; transform: translate(17px, -23px) scale(0.5) rotate(230deg); %7D %7D @keyframes confd %7B 0%25 %7B opacity: 0.7; transform: translate(-20px, 20px) rotate(0); %7D 18%25 %7B opacity: 1; transform: translate(-5px, -10px) rotate(60deg); %7D 76%25 %7B opacity: 1; transform: translate(-8px, -18px) rotate(180deg); %7D to %7B opacity: 0; transform: translate(-10px, -23px) scale(0.5) rotate(230deg); %7D %7D .conf0 %7B fill: %23fc6394; %7D .conf2 %7B fill: %235adaea; %7D .conf3 %7B fill: %23974cbe; %7D .conf6 %7B fill: %23f9b732; %7D .yellow-strip, .conf7, .conf8 %7B fill: none; stroke-miterlimit: 10; %7D .conf7 %7B display: none; stroke: %23000; %7D .yellow-strip, .conf8 %7B stroke: %23f9b732; stroke-width: 9; stroke-linecap: round; %7D .yellow-strip %7B animation: confdash .5s ease 1; %7D %3C/style%3E%3Ccircle class='conf2' cx='195.2' cy='232.6' r='5.1' style='animation: confb .5s ease-out 1' transform-origin='195.2px 232.6px' /%3E%3Ccircle class='conf0' cx='230.8' cy='219.8' r='5.4' style='animation: confb .5s ease-out 1' transform-origin='230.8px 219.8px' /%3E%3Ccircle class='conf0' cx='178.9' cy='160.4' r='4.2' style='animation: confc .5s ease-out 1' transform-origin='178.9px 156.2px' /%3E%3Ccircle class='conf6' cx='132.8' cy='123.6' r='5.4' style='animation: confd .5s ease-out 1' transform-origin='133px 118px' /%3E%3Ccircle class='conf0' cx='151.9' cy='105.1' r='5.4' style='animation: confd .5s ease-out 1' transform-origin='152px 100px' /%3E%3Cpath class='conf0' d='m129.9 176.1-5.7 1.3c-1.6.4-2.2 2.3-1.1 3.5l3.8 4.2c1.1 1.2 3.1.8 3.6-.7l1.9-5.5c.5-1.6-.9-3.2-2.5-2.8z' style='animation: confd .5s ease-out 1' transform-origin='127px 176px' /%3E%3Cpath class='conf6' d='m284.5 170.7-5.4 1.2c-1.5.3-2.1 2.2-1 3.3l3.6 3.9c1 1.1 2.9.8 3.4-.7l1.8-5.2c.5-1.3-.8-2.8-2.4-2.5z' style='animation: confb .5s ease-out 1' transform-origin='282.3px 170.6px' /%3E%3Ccircle class='conf6' cx='206.7' cy='144.4' r='4.5' style='animation: confc .5s ease-out 1' transform-origin='206.7px 140px' /%3E%3Cpath class='conf2' d='M176.4 192.3h-3.2c-1.6 0-2.9-1.3-2.9-2.9v-3.2c0-1.6 1.3-2.9 2.9-2.9h3.2c1.6 0 2.9 1.3 2.9 2.9v3.2c0 1.6-1.3 2.9-2.9 2.9z' style='animation: confc .5s ease-out 1' transform-origin='174.8px 183.4px' /%3E%3Cpath class='conf2' d='M263.7 197.4h-3.2c-1.6 0-2.9-1.3-2.9-2.9v-3.2c0-1.6 1.3-2.9 2.9-2.9h3.2c1.6 0 2.9 1.3 2.9 2.9v3.2c-.1 1.6-1.4 2.9-2.9 2.9z' style='animation: confb .5s ease-out 1' transform-origin='262px 188.5px' /%3E%3Cpath class='yellow-strip' d='M179.7 102.4s6.6 15.3-2.3 25c-8.9 9.7-24.5 9.7-29.7 15.6-5.2 5.9-.7 18.6 3.7 28.2 4.5 9.7 2.2 23-10.4 28.2' /%3E%3Cpath class='yellow-strip conf8' d='M252.2 156.1s-16.9-3.5-28.8 2.4c-11.9 5.9-14.9 17.8-16.4 29-1.5 11.1-4.3 28.8-31.5 33.4' /%3E%3Cpath class='conf0' d='M277.5 254.8h-3.2c-1.6 0-2.9-1.3-2.9-2.9v-3.2c0-1.6 1.3-2.9 2.9-2.9h3.2c1.6 0 2.9 1.3 2.9 2.9v3.2c0 1.6-1.3 2.9-2.9 2.9z' style='animation: confa .5s ease-out 1' transform-origin='276px 246px' /%3E%3Cpath class='conf3' d='M215.2 121.3c.3.6.8 1 1.5 1.1 1.6.2 2.2 2.2 1.1 3.3-.5.4-.7 1.1-.6 1.7.3 1.6-1.4 2.8-2.8 2-.6-.3-1.2-.3-1.8 0-1.4.7-3.1-.5-2.8-2 .1-.6-.1-1.3-.6-1.7-1.1-1.1-.5-3.1 1.1-3.3.6-.1 1.2-.5 1.5-1.1.7-1.5 2.7-1.5 3.4 0z' style='animation: confc .5s ease-out 1' transform-origin='213.5px 120.2px' /%3E%3Cpath class='conf3' d='M224.5 191.7c.3.6.8 1 1.5 1.1 1.6.2 2.2 2.2 1.1 3.3-.5.4-.7 1.1-.6 1.7.3 1.6-1.4 2.8-2.8 2-.6-.3-1.2-.3-1.8 0-1.4.7-3.1-.5-2.8-2 .1-.6-.1-1.3-.6-1.7-1.1-1.1-.5-3.1 1.1-3.3.6-.1 1.2-.5 1.5-1.1.6-1.5 2.7-1.5 3.4 0z' style='animation: confb .5s ease-out 1' transform-origin='222.8px 190.6px' /%3E%3Cpath class='conf3' d='M312.6 242.1c.3.6.8 1 1.5 1.1 1.6.2 2.2 2.2 1.1 3.3-.5.4-.7 1.1-.6 1.7.3 1.6-1.4 2.8-2.8 2-.6-.3-1.2-.3-1.8 0-1.4.7-3.1-.5-2.8-2 .1-.6-.1-1.3-.6-1.7-1.1-1.1-.5-3.1 1.1-3.3.6-.1 1.2-.5 1.5-1.1.7-1.5 2.7-1.5 3.4 0z' style='animation: confa .5s ease-out 1' transform-origin='310.9px 241px' /%3E%3Cpath class='yellow-strip conf8' d='M290.7 215.4s-14.4-3.4-22.6 2.7c-8.2 6.2-8.2 23.3-17.1 29.4-8.9 6.2-19.8-2.7-32.2-4.1-12.3-1.4-19.2 5.5-20.5 10.9' /%3E%3C/svg%3E`),
...
>
  <style>
    ...
    .yellow-strip {
      animation: confdash ${lengthOfAnimation/1000}s ease 1;
    }
  </style>
  <circle
    class="conf2"
    ...
    cy="232.6"
    r="5.1"
    style="animation: confb ${lengthOfAnimation/1000}s ease-out 1"
  ...
  <circle
    ...
    cy="160.4"
    r="4.2"
    style="animation: confc ${lengthOfAnimation/1000}s ease-out 1"
  ...
  <circle
    ...
    cy="123.6"
    r="5.4"
    style="animation: confd ${lengthOfAnimation/1000}s ease-out 1"
  ...
  <path
    ...
    style="animation: confa ${lengthOfAnimation/1000}s ease-out 1"
  ...
  return vscode.Uri.parse(`data:image/svg+xml;utf8,${encodeSVG(svg)}`);
}
